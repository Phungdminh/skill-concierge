  ...
  return (
    ...
    >
      <div className="mb-10 flex flex-col items-start justify-between gap-4 md:mb-12 md:flex-row md:items-end">
        ...
        <Link
          href="/tools"
          className="group inline-flex items-center gap-1.5 self-start rounded-full border border-white/10 bg-white/[0.02] px-4 py-2 text-sm text-foreground/85 transition hover:bg-white/[0.06] md:self-end"
        >
          Xem tất cả tool
