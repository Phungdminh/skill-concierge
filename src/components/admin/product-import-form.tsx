...
const TEMPLATES = {
  ...
  webwork: `kind\ttitle\tslug\ttagline\tdescription\tyoutube_url\trepo_url\tthumbnail_url\tstatus\nwebwork\tLanding page coach 1-1\tlanding-coach\tLanding page cá nhân gọn đẹp\tShowcase web cá nhân đã làm\t\thttps://demo.example.com\t\tdraft`,
...
const KIND_LABEL: Record<string, string> = { tool: 'Tool', prompt: 'Prompt', webwork: 'Web cá nhân' };
